...
public class CloseAccount extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(360, 50, 311, 43);
        ...
        Transaction.setBounds(410, 220, 160, 23);
    ...
    private void TransactionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TransactionActionPerformed
        SavingAccount account0=new SavingAccount();
        if(account0.close(Integer.parseInt(jTextField1.getText().toString())))
        {
            JOptionPane.showMessageDialog(null,"Closed Successfully Successfully");
        }
        else
